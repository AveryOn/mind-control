...
export const useMainStore = defineStore('mainStore', () => {
    ...
    const openResultForCheck: Ref<ResultForCheck | null> = ref<ResultForCheck | null>({
        ...
        answers: [
            { id: 1, answer: null, questionId: 1,  },
            { id: 2, answer: 'шото-шото', questionId: 2, },
            { id: 3, answer: 'getElementsById', questionId: 3,  },
            { id: 4, answer: 'Я отвечаю что знаю, просто забыл блин сорянчек', questionId: 4,  },
            { id: 5, answer: '[{"answer": "async..await"}, {"answer": "Promises"}]', questionId: 5,  },
            { id: 6, answer: '[{"answer": "v-if / v-else"}, {"answer": "v-for"}]', questionId: 6,  },
            { id: 7, answer: null, questionId: 7,  },
            { id: 8, answer: 'места объявления функции', questionId: 8,  },
            { id: 9, answer: 'loadeddata', questionId: 9,  },
            { id: 10, answer: 'const', questionId: 10,  },
        ],
        questions: [
            { id: 1, testId: 3, number: 1, question: 'Что такое DOM?', type: 'text' },
            { id: 2, testId: 3, number: 2, question: 'Что такое замыкание JS?', type: 'text' },
